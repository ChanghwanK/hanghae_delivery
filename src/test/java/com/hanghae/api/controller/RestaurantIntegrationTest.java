...
class RestaurantIntegrationTest {
    ...
    class RegisterRestaurants {
        ...
        void test4() {
            ...
            System.out.print(" ======== response Restaurant ======== ");
             Arrays.stream(responseRestaurants).forEach(System.out::println);
...
//                System.out.println("register " + registerRestaurant.getDeliveryFee());
//                System.out.println("response "+ responseRestaurant.getDeliveryFee());
                //assertEquals(registerRestaurant.getDeliveryFee(), responseRestaurant.getDeliveryFee());
                System.out.print(" ======== registerRestaurant ======== ");
